...
Browser → web/      React + BlockNote editor (port 3000) — Icon Rail UI (Linear-style), local folder via File System Access API, full-width diagram blocks, zoom/pan preview, Excalidraw drawing editor for .excalidraw files
  ↓ proxy
