...
import { renderDiagram, TEMPLATE_KROKI_MAP, buildDslPrompt, type KrokiDiagramType } from "../kroki-bridge.js";

export function registerRenderAndEmbedTool(server: McpServer): void {
  server.registerTool(
    ...
    async (args) => {
      ...
      const krokiType = (args.diagram_type as KrokiDiagramType | undefined)
...
export function registerGetDslPromptTool(server: McpServer): void {
  server.registerTool(
