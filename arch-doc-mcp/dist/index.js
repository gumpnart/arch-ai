...
server.registerTool("get_template_placeholders", {
...
server.registerTool("fill_template", {
...
server.registerTool("get_document_checklist", {
...
server.registerTool("generate_document", {
    ...
    contents: [
        {
            ...
            mimeType: "application/json",
            text: JSON.stringify(ALL_TEMPLATE_IDS.map((id) => {
                const t = TEMPLATES[id];
