...
function base(spec, id = genId()) {
    const roundness = spec.rounded ?? false
    ...
    return {
        ...
        fillStyle: (spec.fillStyle ?? "hachure"),
...
export function buildElements(specs) {
    const elements = [];
    const idMap = {}; // spec index → element id
...
function buildText(spec, id, containerId = null) {
